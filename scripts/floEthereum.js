(function (EXPORTS) { //floEthereum v1.0.1a
  ...
  // Make sure ethers.umd.min.js is loaded in your environment
    
//   const deriveEthereumAddressFromFLOPrivateKey = floEthereum.ethAddressFromPrivateKey = function (privateKey, onlyEvenY = true) {
